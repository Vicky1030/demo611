...
public class Statistics implements Serializable {
    ...
    public Statistics(Integer id, Integer provinceId, Integer cityId, String address, Integer so2Value, Integer so2Level, Integer coValue, Integer coLevel, Integer spmValue, Integer spmLevel, Integer aqiId, String confirmDate, Date confirmTime, Integer gmId, String fdId, String information, String remarks) {
        this.id = id;
